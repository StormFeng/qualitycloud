...
//		geo_pro_type_id = getIntent().getStringExtra("geo_pro_type_id");
		Log.e("wqf","geo_id::"+geo_id+"   "+"name::"+name+"   "+"geo_pro_type_id::"+geo_pro_type_id);
		initTitle();
//		initViewPager();
	...
	public void onApiSuccess(NetResult res, String tag) {
		...
		if(res.isOK()){
			GeoProFirstDetailBean bean = (GeoProFirstDetailBean) res;
			geo_pro_type_id=bean.getContent().getGeo_pro_type_id();
			initViewPager();
		}
	}
