 ...
 * 
 */
public class RegisterTwoActivity extends BasePicActivity implements View.OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		man_tv.setOnTouchListener(this);
		woman_tv.setOnTouchListener(this);
		nick_name_et.setOnTouchListener(this);
